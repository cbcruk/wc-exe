/**
 * Types of the bridge — the part that drives a WebContainer from Node.
 *
 * Kept apart from the CLI's option bags because this is the durable surface:
 * it describes talking to the runtime, and stays meaningful to any consumer,
 * not just this CLI.
 */
